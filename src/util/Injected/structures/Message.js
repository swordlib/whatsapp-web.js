// port from src/structures/Message.js for inject to browser, just change MessageMedia
...
const ScheduledEvent = require('../../../structures/ScheduledEvent'); // eslint-disable-line no-unused-vars
